...
import {CCardTitle, CCardText, CCardLink, CRow, CCol, CCardImage, CCardBody, CCardFooter} from '@coreui/react';
  ...
  const Cards = () => {
    return (
      ...
      <CRow xs={{ cols: 1, gutter: 4 }} md={{ cols: 2 }}>
                        <CCol xs>
                          <CCard>
                            <CCardImage orientation="top" src="https://github.com/kait-weishaar/Challenge-2/blob/main/assets/images/pexels-jim-de-ramos-1263426.jpg" />
                            <CCardBody>
